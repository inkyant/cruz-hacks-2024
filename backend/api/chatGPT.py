...
def get_article(transcript: str, articles: str):
    ...
    prompt2 = """Choose the most relevant of these snopes articles to the topic in the transcript. Respond with just one number, or -1 only if none apply. For example, your response could be:1"""
